...
/** Single-server/shared-repository contention, using a disposable Access file per test. */
class AccessLibraryBorrowConcurrencyTest {
    ...
    void setUp() throws Exception {
        database = temporaryDirectory.resolve("borrow-concurrency.accdb");
    ...
    private DefaultLibraryService persistedView() {
