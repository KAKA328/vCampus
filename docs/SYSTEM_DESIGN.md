...
| `COURSE_MANAGE_V2` / `COURSE_MANAGE_V3` | `CourseManagementCommand`：新增课程和修改课程详情使用 V3 精确学分载荷；查询、课程状态、教学班和轮次操作使用 V2。`UPDATE_OFFERING_TEACHING_INFO(offeringId, teacherId, location)` 仅修改任课教师和地点，不修改上课时间 | `COURSE_MANAGE` |
