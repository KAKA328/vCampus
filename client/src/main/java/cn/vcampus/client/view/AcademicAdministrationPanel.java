...
final class AcademicAdministrationPanel extends JPanel {
    ...
    private void confirmGraduation() {
        ...
        if (JOptionPane.showConfirmDialog(this,
                ...
                + "本次审查累计 " + cn.vcampus.common.CreditFormat.display(assessment.getCredits().getEarnedCreditsDecimal()) + " 学分，要求 "
                + cn.vcampus.common.CreditFormat.display(assessment.getRequiredCreditsDecimal()) + " 学分。\n请确认其他毕业条件已经人工核查。",
        ...
        if (action == Action.STUDENTS) {
            ...
            for (Object item : (List<?>) data) {
                ...
                rows.add(new Object[] {r.getCourseId(), r.getCourseName(), r.getSemester(),
                        r.getAttemptNo(), r.getAttemptType(), r.getScore(), r.isPassed() ? "是" : "否", cn.vcampus.common.CreditFormat.display(r.getEarnedCreditsDecimal())});
            }
        } else if (action == Action.CREDITS) {
            CreditSummary r = (CreditSummary) data;
            columns = new String[] {"学号", "当前学分", "通过课程", "待重修", "历史重修"};
            rows.add(new Object[] {r.getStudentId(), cn.vcampus.common.CreditFormat.display(r.getEarnedCreditsDecimal()), r.getPassedCourses(),
            ...
            for (Object item : assessments) {
                ...
                rows.add(new Object[] {r.getId(), r.getStudentId(), cn.vcampus.common.CreditFormat.display(r.getCredits().getEarnedCreditsDecimal()),
                        cn.vcampus.common.CreditFormat.display(r.getRequiredCreditsDecimal()), cn.vcampus.common.CreditFormat.display(r.getShortfallDecimal()), r.getCredits().getPendingRetakes(),
            ...
            assessmentInfo.setText(assessment == null ? "暂无审查记录" : "最新审查："
                    + cn.vcampus.common.CreditFormat.display(assessment.getCredits().getEarnedCreditsDecimal()) + " / " + cn.vcampus.common.CreditFormat.display(assessment.getRequiredCreditsDecimal())
