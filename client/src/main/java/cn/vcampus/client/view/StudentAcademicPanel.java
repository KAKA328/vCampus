            ...
            @Override protected void done() {
                ...
                try {
                    ...
                    if (type == QueryType.CREDITS) {
                        ...
                        earned.setText(cn.vcampus.common.CreditFormat.display(summary.getEarnedCreditsDecimal()));
                        ...
                        model.replaceRows(Collections.singletonList(new Object[] {summary.getStudentId(),
                                cn.vcampus.common.CreditFormat.display(summary.getEarnedCreditsDecimal()), summary.getPassedCourses(),
    ...
    private static List<Object[]> rows(Object payload) {
        ...
        for (Object item : (List<?>) payload) {
            ...
            rows.add(new Object[] {record.getCourseId(), record.getCourseName(), record.getSemester(),
                    ...
                    record.isPassed() ? "通过" : "未通过", cn.vcampus.common.CreditFormat.display(record.getEarnedCreditsDecimal())});
        }
        return rows;
    }
