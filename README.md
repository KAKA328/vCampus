...
- 图书馆已接入分角色 Swing 页面、免费图书、借阅上限、到期提醒、共享钱包原价赔偿，以及 V4 实体册、借阅书名快照、资料编辑。新客户端须配套新服务器与完整表结构；[V4 接口及迁移](docs/LIBRARY_V4_CATALOG.md)。
- 图书馆验收可用脚本生成独立新库：80 种图书、正常/边界/赔偿数据及 8 个并发账号；[测试数据、生成步骤和验收清单](test-data/LIBRARY_ACCEPTANCE.md)。不覆盖已有演示库、不提交本地数据库。
